declare module game{
    ...
    */
    class Global{
        ...
        /**显示根节点 上面 */
        public static root_top:Laya.Sprite;
        /**显示根节点 下边*/
        public static root_bottom:Laya.Sprite;
        /**全局平台 */
...
declare module game.ui {
    ...
    class BaseWindow extends BaseUI {
         ...
         */
        public open(delayTime?:number):void;
        /**横屏时布局设置 */
        public scaleH():void;
        /**竖屏时布局设置 */
        public scaleV():void;
...
declare module game.scene{
    ...
    */
    class LayerManager{
         ...
         * @param layerNum 
         */
        public removeChild(child: Laya.View|any,layerNum?:LayerName):Laya.Node;
        /**
         * 删除某层的全部对象
         * @param layerNum
         */
...
declare module game.scene.king{
    ...
    */
    class King extends BaseKing{
        ...
        /**受击点 */
		public readonly atkedPoint:Laya.Point;
        /**
		 * 获得射击特效旋转角度,比如子弹，箭
		 * 俯视游戏方向角度为0,跟着生物旋转
		 ...
		 * 
		 */
		public getAtkingEftRotation(atkingX?:number,atkingY?:number):number;
		/**
		 * 死亡时调用
		 */
		public onDead():void;
    ...
    */
	...
	export class BaseBone extends BaseDisplay{
		 ...
		 */
		public play(isLoop?:boolean,name?:string,parent?:any):void
        /**
		 * 停止播放
		 */
		public stop():void;
